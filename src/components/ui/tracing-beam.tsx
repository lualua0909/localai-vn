...
export const TracingBeam = ({
  ...
  const initialBeamLength = Math.min(300, svgHeight * 0.15);
  ...
  const y2 = useSpring(
    useTransform(
      scrollYProgress,
      [0, 1],
      [50 + initialBeamLength, svgHeight - 200]
    ),
    {
      stiffness: 500,
      damping: 90,
      ...
      <div className="absolute top-3 -left-4 md:-left-20">
        ...
        >
          <motion.div
            ...
            className="h-2 w-2 rounded-full border border-neutral-300 bg-white dark:border-neutral-600"
          />
        </motion.div>
        <svg
