          ...
          {verificationSent && (
            <div className="mt-6 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5">
              ...
              <p className="mt-2 text-[13px] text-[var(--color-text-secondary)]">
                Vui lòng kiểm tra hộp thư <strong>{email}</strong> và nhấn vào
                liên kết xác nhận. Sau đó quay lại đây để đăng nhập.
              </p>
              <div className="mt-4 flex gap-3">
                <button
                  ...
                  className="rounded-lg bg-emerald-500/20 px-3 py-1.5 text-[13px] font-medium text-emerald-400 transition-colors hover:bg-emerald-500/30"
                >
                  Gửi lại email
                </button>
                <button
                  ...
                  className="rounded-lg px-3 py-1.5 text-[13px] font-medium text-[var(--color-text-secondary)] transition-colors hover:text-[var(--color-text)]"
                >
                  Đăng nhập
                </button>
              </div>
